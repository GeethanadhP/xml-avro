...
//        rootPrimitiveWithType("xs:dateTime", "2014-09-10T05:58:33Z", Schema.Type.LONG, 1410353913000L);
    ...
    public void rootRecord() {
        String xsd = "<xs:schema xmlns:xs='http://www.w3.org/2001/XMLSchema'>" + "   <xs:element name='root'>"
    ...
    public void nestedRecursiveRecords() {
        String xsd = "<xs:schema xmlns:xs='http://www.w3.org/2001/XMLSchema'>" + "  <xs:complexType name='type'>"
    ...
    public void arrayFromComplexTypeSequenceOfChoiceElements() throws JSONException {
        ...
        String xsd = "<xs:schema xmlns:xs='http://www.w3.org/2001/XMLSchema'>" + "  <xs:element name='root'>"
                ...
                + "          <xs:element name='x' type='xs:string'/>" + "          <xs:element name='y' type='xs:int'/>"
        ...
        // Then
        JSONAssert.assertEquals(
                "{" + "    'type': 'record'," + "    'fields': [" + "        {" + "            'name': 's',"
                        + "            'type': 'string'" + "        }," + "        {" + "            'name': 'i',"
                        + "            'type': 'int'" + "        }," + "        {" + "            'name': 'type0',"
                        + "            'type': {" + "                'type': 'array'," + "                'items': {"
                        + "                    'type': 'record'," + "                    'name': 'type1',"
                        + "                    'fields': [" + "                        {"
                        + "                            'name': 'x',"
                        + "                            'type': ['null','string']" + "                        },"
                        + "                        {" + "                            'name': 'y',"
