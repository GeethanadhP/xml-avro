...
public class OldSchemaBuilder {
    ...
    private List<Schema.Field> createFields(XSComplexTypeDefinition type) {
        ...
        if (type.derivedFromType(SchemaGrammar.fAnySimpleType, XSConstants.DERIVATION_EXTENSION)) {
            ...
            String name = validName(OldSchemaBuilder.TEXT_VALUE);
            ...
            field.addProp(Source.SOURCE, "" + new Source(OldSchemaBuilder.TEXT_VALUE, false));
            fields.put(field.getProp(Source.SOURCE), field);
        }
                ...
                case XSConstants.MODEL_GROUP:
                    ...
                    if (particle.getMaxOccurs() <= 1 && !particle.getMaxOccursUnbounded())
                        ...
                        fields.put(fieldName,
                                new Schema.Field(fieldName, createGroupSchema(nextTypeName(), subGroup), null, null));
                    }
                    break;
    ...
    private Schema.Field createField(Iterable<Schema.Field> fields, XSObject source, XSTypeDefinition type,
                                     boolean optional, boolean array) {
    ...
    private static class ErrorHandler implements XMLErrorHandler, DOMErrorHandler {
        ...
        void throwExceptionIfHasError() {
            ...
            if (error != null) {
                ...
                String location = "at:" + locator.getUri() + ", line:" + locator.getLineNumber() + ", char:"
